...
OPENAI_OPENAI_API_KEY = os.getenv("OPENAI_OPENAI_API_KEY")
...
def process_input(user_input, client=OpenAI(
    api_key=OPENAI_OPENAI_API_KEY
)):
    """
    ...
    for match in pinecone_results.matches:
        t = match.metadata.get("Text", "")
        context_snippets.append(f"Text: {t}\n")
    ...
    messages = [
        ...
        },
        {
            ...
            "content": (
                ...
                "Use the following reference texts from a textbook to guide your answer:\n"
                f"{reference_text}\n\n"
